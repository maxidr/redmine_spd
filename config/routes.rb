ActionController::Routing::Routes.draw do |map|
  ...
  # Manual added for redmine-cas-plugin (https://github.com/ifad/redmine-cas-plugin/issues/11)
  map.match 'login_without_cas', :controller => 'account', :action => 'login_without_cas'
end
